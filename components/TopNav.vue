<template>
	<div id="TopNav" class="bg-white z-30 flex items-center w-full border-b h-[61px]">
		<div
		...
		>
			...
			<div
				class="hidden md:flex items-center bg-[#F1F1F2] p-1 rounded-full max-w-[300px] w-full"
			>
				<input
					type="text"
			...
			<div class="flex items-center justify-end gap-3 min-w-[275px] max-w-[320px] w-full">
				...
				<div v-if="!$userStore.id" class="flex items-center">
					<button
						...
						class="flex items-center bg-[#F02C56] text-white rounded-md px-3 py-[6px]"
					>
